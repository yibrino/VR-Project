...
public class WaypointManagerWindow : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        {
            EditorGUILayout.HelpBox("Please assign a Waypoint origin tranform. ", MessageType.Warning);
        }
        else
        {
    ...
    void CreateWaypoint()
    {
        GameObject waypointObject =
            new GameObject("Waypoint " + waypointOrigin.childCount, typeof(Waypoint));
        ...
        {
            waypoint.previousWaypoint = waypointOrigin
                .GetChild(waypointOrigin.childCount - 2)
